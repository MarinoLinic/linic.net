			...
			<div className="md:w-1/3 w-full flex flex-col">
				...
				<section>
					<div>
						...
						<p>I am a fan of TypeScript, React, Node, and all things web, including work on the backend. </p>
						<p>
							<br></br>
							<p>
				...
				<section>
					...
					<br />
					<p>
						I started programming right about the time I started university. My knowledge is substantially derived
						from self-study. I remember when—right around the time I enrolled—I downloaded a small C++ jumping game
						with ~400 lines of code. I spent that weekend, completely glued to my screen, editing and playing
						around with the code, only to end up set for the next month of the semester without having to pay any
						attention to my C++ course. Stuff like that really pays off!
					</p>
					<br />
					<p>
						I started getting into web development during my study and made a collection of projects you can see at{' '}
