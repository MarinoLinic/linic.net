...
export const skills = {
	...
	'Alati i tehnologije': [
		...
		{ name: 'REST API',        included: true,  tags: 'frontend,backend,web' },
...
export const certifications = [
	{ name: 'Certifikat o sudjelovanju - DSC Europe \'21',          included: true, tags: 'backend,python,web,automation,testing' },
